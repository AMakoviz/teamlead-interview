			...
			<div class="aui-dialog2-content">
				<div class="tl-user-area">
					...
					<div class="tl-border">
						...
						<div>
							<button id="tl-set-assignee-button" class="aui-button primary"
				...
				<div class="tl-summary-area">
					...
					<div>
						<button id="tl-set-summary-button" class="aui-button primary"
						        onClick="updateSummary()">${AJS.I18n.getText("tl.test.update")}</button>
					</div>
				</div>
			</div>
			<footer class="aui-dialog2-footer">
				<div class="aui-dialog2-footer-actions">
					<button id="tl-close-button" class="aui-button aui-button-link">${AJS.I18n.getText("tl.button.close")}</button>
				</div>
			</footer>
		</section>
	`;
...
function updateSummary() {
	...
	var summary = jQuery("#tl-summary").val();
	var issueKey = JIRA.Issue.getIssueKey();

	alert("summary:" + summary + ", issueKey:" + issueKey);
	//TODO IMPLEMENT
}
